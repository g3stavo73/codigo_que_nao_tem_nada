...
const sweetMessages = [
  'Tem alguém pensando em você com muito carinho agora... 💗',
  'Adivinha? Tem uma surpresa linda chegando... 🎁✨',
  'Não corre, tá? Fica só mais um pouquinho comigo... 🫶',
  'Você deixa tudo mais bonito só por existir... 🌷',
  'Hoje o dia ficou mais especial porque é o seu dia... ☀️',
  'Essa surpresa foi feita com muito carinho... 💝',
  'Fica aí, a parte mais fofa ainda vem... ✨',
  ...
  <div class="card relative z-10 w-11/12 max-w-2xl mx-auto my-8 p-8 md:p-10 rounded-[24px]">
    ...
    <div v-else-if="phase === 'bait'" class="flex flex-col items-center gap-6 py-12 text-center fade-in">
      ...
      <h2 class="text-3xl md:text-4xl font-bold text-white">
        Hehe... achou mesmo que isso era real? 😌💗
      </h2>
      <p class="text-white/50 text-base max-w-md">
        Não existe mesmo... mas a surpresa de verdade está quase aí. 💕
      </p>
    ...
    <div v-else-if="phase === 'timer'" class="flex flex-col items-center gap-8 py-8 fade-in">
      ...
      <div class="relative w-[200px] h-[200px] flex items-center justify-center">
        ...
        <div class="z-10 text-center">
          ...
          <div class="text-xs text-white/40 mt-1">segundinhos</div>
        </div>
      </div>
    ...
    <div v-else class="flex flex-col items-center gap-5 text-center py-4 fade-in">
      ...
      <h2 class="message-title text-3xl md:text-[32px] font-bold text-white leading-tight">
        Pra pessoa mais especial do meu mundo
      </h2>
      ...
      <p class="message-text text-base text-white/80 leading-relaxed max-w-md">
        Você é uma das pessoas mais incríveis que eu já conheci, e eu tenho muita sorte de poder te ver sorrir.
      </p>
      <p class="message-text text-base text-white/80 leading-relaxed max-w-md">
        Que seu dia seja lindo, leve e cheio de coisas boas — porque você merece tudo de melhor.
      </p>
      <div class="message-signature text-[15px] text-white/60 italic mt-2">Feliz aniversário 💕</div>
